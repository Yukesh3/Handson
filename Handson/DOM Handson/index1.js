...
function one() {
    document.getElementById('text').innerText="1 ^st Question"
}
...
document.getElementsByTagName('h2')[0].innerText="2 ^nd Question";
...
function three() {
  document.getElementsByClassName('box')[0].innerText="3 ^rd Question"
}
